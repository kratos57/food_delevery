...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => Onboard(), // Default route (onboarding page)
        '/home': (context) => Home(), // Home page route
        '/signup': (context) => SignUp(), // Signup page route
        '/wallet': (context) => Wallet(), // Wallet page route
        '/adminLogin': (context) => AdminLogin(), 
        '/order': (context) => Order(),// Admin login route
      },
      // Set the initial route (you can change it to other routes like '/home' or '/signup')
      initialRoute: '/',
    );
